...
public class CommitCartOrder extends myBaseActivity implements View.OnClickListener {
    SM_Payway payways;//支付方式，收货地址
    TextView txt_totalprice //商品总额
            , txt_downprice;//商品优惠
    RecyclerView rv_cart;//订单商品
...
//    List<BaseGoods> list;
    ...
    protected void initView() {
        setContentView(R.layout.activity_commit_cart_order);
        ...
        for (BaseGoods g : order.GetGoods()) {
            ...
            if (g.gettime() != null && !g.gettime().equals("")) {
                ...
                try {
                    ...
                    Log.i(TAG, "CommitCartOrder  Line 607 exception:" + e.getMessage());
                }
            }
        }
    ...
    private void buildPaypwdDialog() {
        ...
        btn_ok.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                generalhelper.ToastShow(CommitCartOrder.this, pwd);
                paypwdInputDialog.dismiss();
            }
        });
        ...
        switch (order.getpay_type()) {
                ...
                aliPay.setOnPayListner(new AliPay.OnAliPayListner() {
                    ...
                    public void done(String stat) {
                        if (stat.equals("9000")) {
                            ...
                            isCommited = false;
                            generalhelper.ToastShow(CommitCartOrder.this, "支付失败");
                        }
                    }
            ...
            case 4:
                ...
                new Thread(new Runnable() {
                    @Override
                    public void run() {
                        api = WXAPIFactory.createWXAPI(CommitCartOrder.this, Constants.APP_ID, false);
    ...
    TimePickerDialog.OnTimeSetListener onTimeSetListener = new TimePickerDialog.OnTimeSetListener() {
        ...
        public void onTimeSet(TimePicker view, int hour, int minute) {
            ...
            if (time.compareTo(nowtime) < 0) {
                generalhelper.ToastShow(CommitCartOrder.this, "选择的配送时间不得小于当前时间");
            } else {
...
//            imageLoader.loadDrawableRS(CommitCartOrder.this, g.getDraw(), holder.iv_preview, new IImageloader() {
//                @Override
//                public void onDownloadSucc(Bitmap bitmap, String c_url, View imageView, int w, int h) {
//                    ((ImageView) imageView).setImageBitmap(bitmap);
//                }
                        ...
                        try {
                            ...
                            for (int i = 0; i < jsonArray.length(); i++) {
                                ...
                                if (obj.getString("result").equals("0")) {
                                    ...
                                    isCommited = false;
                                    inserted = false;
                                    generalhelper.ToastShow(CommitCartOrder.this, "订单新增错误~");
                                }
                            }
                        } catch (Exception e) {
                            inserted = false;
...
//                        }
                ...
                generalhelper.ToastShow(CommitCartOrder.this, msg.obj.toString());
            }
        }
    };
            ...
            if (intent.hasExtra("data")) {
                ...
                switch (resp.getErrcode()) {
                    case BaseResp.ErrCode.ERR_OK:
                        generalhelper.ToastShow(CommitCartOrder.this, "支付成功");
                        handler.obtainMessage(resultCodes.PAYCOMPLETE).sendToTarget();
                        break;
                    case BaseResp.ErrCode.ERR_USER_CANCEL:
                        isCommited = false;
                        generalhelper.ToastShow(CommitCartOrder.this, "已取消支付");
                        break;
                    case BaseResp.ErrCode.ERR_AUTH_DENIED:
                        isCommited = false;
                        generalhelper.ToastShow(CommitCartOrder.this, "未授权");
                        break;
                    default:
                        isCommited = false;
                        generalhelper.ToastShow(CommitCartOrder.this, "未知错误");
                        break;
                }
            }
            toCloseProgress();
