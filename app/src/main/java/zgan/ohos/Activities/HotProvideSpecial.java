 ...
 * 优惠等特殊类特供
 */
public class HotProvideSpecial extends myBaseActivity{
    int pageindex = 0;
    ...
    protected void initView() {
        ...
        mLayoutManager = new LinearLayoutManager(HotProvideSpecial.this);
    ...
    class myAdapter extends RecyclerView.Adapter<myAdapter.ViewHoler> {
        ...
        public myAdapter() {
            width = AppUtils.getWindowSize(HotProvideSpecial.this).x;
            height = 5 * width;
        }
        ...
        public void onBindViewHolder(ViewHoler holder, int position) {
            ...
            holder.itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    refreshview.setRefreshing(false);
                    Intent intent = new Intent(HotProvideSpecial.this, HightQualityDetail.class);
