...
public class SecondShoppingCart extends myBaseActivity implements View.OnClickListener, CompoundButton.OnCheckedChangeListener {
    ...
    protected void initView() {
        ...
        bussinessCid=getIntent().getStringExtra("bussinessCid");
        cartDal = new ShoppingCartDal();
        orderDal = new SM_OrderPayDal();
        mcartDal=new MainShoppingCartDal();
...
//                isLoadingMore = false;
        ...
        rvcarts = (LinearLayout) findViewById(R.id.rv_carts);
        ...
        density = AppUtils.getDensity(SecondShoppingCart.this);
    ...
    void bindData() {
        ...
        for (final ShoppingCartM cartM : list) {
            ...
            //boolean isAll = true;
            final ViewGroup cv = (ViewGroup) LayoutInflater.from(SecondShoppingCart.this).inflate(R.layout.lo_scart_item, null, false);
            ...
            for (final SM_GoodsM goodsM : cartM.getproductArray()) {
                final ViewGroup v = (ViewGroup) LayoutInflater.from(SecondShoppingCart.this).inflate(R.layout.lo_scart_subitem, pView, false);
                ...
                if (goodsM.gettype_list() != null && goodsM.gettype_list().size() > 0) {
                    ...
                    for (int i = 0; i < tcount; i++) {
                        ImageView iv = new ImageView(SecondShoppingCart.this);
            ...
            if (msg.what == 1) {
                ...
                if (!data.isEmpty()) {
                    try {
                        ...
                        if (result.equals("0")) {
                            list=new ArrayList<>();
                            List<BussinessShoppingCartM> bussinessShoppingCartMs=mcartDal.getList(data).getbussiness_goodsArray();
                            for (BussinessShoppingCartM m:bussinessShoppingCartMs)
                            {
                                if(m.getbussinesscid().equals(bussinessCid))
                                {
                                    list=m.getgoodsarray();
                                    break;
                                }
                            }
                            bindData();
                            ...
                            generalhelper.ToastShow(SecondShoppingCart.this, "服务器错误:" + errmsg);
                ...
                Intent intent = new Intent(SecondShoppingCart.this, CommitCartOrder.class);
        ...
        switch (v.getId()) {
            case R.id.btn_check:
                if (opGoods == null || opGoods.size() == 0) {
                    generalhelper.ToastShow(SecondShoppingCart.this, "还没有选择商品哦！");
                    break;
                }
                toShowProgress();
                    ...
                    public void onResponse(String response) {
                        ...
                        if (result.getresult().equals("0")) {
                            ...
                            handler.post(new Runnable() {
                                @Override
                                public void run() {
                                    generalhelper.ToastShow(SecondShoppingCart.this, result.getmsg());
                                    toCloseProgress();
                                }
                            });
                        }
            ...
            case R.id.btn_delete://删除
                ...
                AlertDialog.Builder builder = new AlertDialog.Builder(SecondShoppingCart.this);
    ...
    @Override
    public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
        //        for (SecondShoppingCartM m : list) {
//            if (isChecked) {
