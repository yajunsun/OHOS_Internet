package zgan.ohos.itemanimator;
...
public class CustomItemAnimator extends SimpleItemAnimator {
    ...
    private List<RecyclerView.ViewHolder> mPendingAdd = new ArrayList<>();
    private List<RecyclerView.ViewHolder> mPendingRemove = new ArrayList<>();
