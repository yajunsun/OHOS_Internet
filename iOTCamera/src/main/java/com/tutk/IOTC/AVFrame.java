...
public class AVFrame {
	...
	public AVFrame(long frameNo, byte frameState,byte[] frameData, int frameDataSize) {
		...
		videoWidth =480; //frameHead.length > 16 ? Packet.byteArrayToInt_Little(frameHead, 16) : 0;
		videoHeight = 320;//frameHead.length > 16 ? Packet.byteArrayToInt_Little(frameHead, 20) : 0;
		frmSize = frameDataSize;
		frmData = frameData;
		frmNo = frameNo;
	}
